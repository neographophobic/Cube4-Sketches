...
#ifndef LoopingBoxes_h
#define LoopingBoxes_h
...
class LoopingBoxes {
  public:
    ...
    LoopingBoxes(Cube cube, int theDelay);
    ...
    // with the provided colours
    void update(rgb_t innerColour = GREEN, rgb_t outerColour = RED);
